...
public class Http01 {
    ...
    private static String path = "test/a";
    private static Map<String, String> headers = new HashMap<String, String>() {{
        put("a", "a");
    }};
    private static Map<String, String> querys = new HashMap<>();
    private static String body = "";

    public static void main(String[] args) throws Exception {
        new Http01().doPost(host, path, headers, querys, body);
    }

    public HttpResponse doPost(String host, String path, Map<String, String> headers,
